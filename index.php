...
<title>Clemezon</title>
    <meta charset="utf-8">
	<meta name="viewport" content="width=device-width,initial-scale=1.0"> <!--Creamos un metadato para visualizacion de dispositivos, donde el contenido se basa en el del dispositivo-->
